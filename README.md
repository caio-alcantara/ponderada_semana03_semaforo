...
| Critério                                                                                                 | Contempla (Pontos) | Contempla Parcialmente (Pontos) | Não Contempla (Pontos) | Observações do Avaliador |
|---------------------------------------------------------------------------------------------------------|---------------------|---------------------------------|-------------------------|--------------------------| 
| Montagem física com cores corretas, boa disposição dos fios e uso adequado de resistores                | 3              | -                          | -                       | Gostei muito da maneira de como os positivos estão coloridos e os negativos estão na cor preta, seguindo as convenções.                  |
| Temporização adequada conforme tempos medidos com auxílio de algum instrumento externo                  |  3              | -                          | -                       |   Segundo o vídeo, é possivel observar as temporizações corretas: 6 segundos no vermelho; 2 segundos no amarelo; 2 + 2 segundos no verde; 2 segundos no amarelo.                      |
| Código implementa corretamente as fases do semáforo e estrutura do código (variáveis representativas e comentários) | 3              | -                          | -                       | Código excelente. Usa POO e loops para aumentar a escalabilidade e legibilidade.                        |
| Extra: Implementou um componente de liga/desliga no semáforo e/ou usou ponteiros no código              | 1              | -                          | -                       | Buzzer serve como um ótimo componente, apitando quando o verde está piscante                      |
|                                                                                                         |                     |                                 |                         | **Pontuação Total: 10**       |
